    ...
    <div className="grid grid-cols-2 md:grid-cols-5 justify-between items-center p-5">
        <div className="flex items-center space-x-2">
           ...
           className="rounded-full h-20 w-20"
            src="https://www.shutterstock.com/image-illustration/3d-render-abstract-minimal-futuristic-concept-1708270069" 
            alt=""
            />
        
          <div>
            <h1 className="text-lg text-white font-bold">Nader Dali</h1>
